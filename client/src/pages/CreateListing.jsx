...
navigate(`/listing/${data._id}`)
  ...
  return (
    <div className='items-center '>
        <h1 className='text-3xl mt-4 text-center font-semibold'>Create a Listing  </h1>
           ...
           <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row mt-8 pl-40">
            ...
            <input onChange={handleChange} id='description'  className='pb-8 p-3 w-3/5 border rounded-lg ' type="text" placeholder='Description' maxLength='100000' minLength='10' required></input>
            <input onChange={handleChange} id='address' className='p-3 w-3/5  rounded-lg border ' type="text" placeholder='Address' maxLength='62' minLength='10' required></input>
